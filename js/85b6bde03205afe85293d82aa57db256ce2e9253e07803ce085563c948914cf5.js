! function() {
    ...
    t = {
    ...
    }, "undefined" != typeof navigator && (e = window || {}, s = function(t) {
        var e, s = "http://www.w3.org/2000/svg",
            i = "",
            a = -999999,
            r = !0,
            n = "",
        ...
        ! function() {
            var t, e = ["abs", "acos", "acosh", "asin", "asinh", "atan", "atanh", "atan2", "ceil", "cbrt", "expm1", "clz32", "cos", "cosh", "exp", "floor", "fround", "hypot", "imul", "log", "log1p", "log2", "log10", "max", "min", "pow", "random", "round", "sign", "sin", "sinh", "sqrt", "tan", "tanh", "trunc", "E", "LN10", "LN2", "LOG10E", "LOG2E", "PI", "SQRT1_2", "SQRT2"],
                s = e.length;
            for (t = 0; t < s; t += 1) d[e[t]] = Math[e[t]]
        ...
        var P, D = (P = 0, function() {
            return n + "__lottie_element_" + (P += 1)
        });
        ...
        function C(t, e) {
            ...
            return s[1] += e, s[1] > 1 ? s[1] = 1 : s[1] <= 0 && (s[1] = 0), S(s[0], s[1], s[2])
        }

        function w(t, e) {
            var s = x(255 * t[0], 255 * t[1], 255 * t[2]);
            return s[2] += e, s[2] > 1 ? s[2] = 1 : s[2] < 0 && (s[2] = 0), S(s[0], s[1], s[2])
        }

        function F(t, e) {
            var s = x(255 * t[0], 255 * t[1], 255 * t[2]);
            return s[0] += e / 360, s[0] > 1 ? s[0] -= 1 : s[0] < 0 && (s[0] += 1), S(s[0], s[1], s[2])
        }
        ...
        ! function(t, e) {
            ...
            function l(t) {
                var e, s = t.length,
                    ...
                    h = a.S = [];
                for (s || (t = [s++]); r < i;) h[r] = r++;
                for (r = 0; r < i; r++) h[r] = h[n = o & n + t[r % s] + (e = h[r])], h[n] = e;
                a.g = function(t) {
                    for (var e, s = 0, r = a.i, n = a.j, h = a.S; t--;) e = h[r = o & r + 1], s = s * i + h[o & (h[r] = h[n = o & n + e]) + (h[n] = e)];
            ...
            function d(t, e) {
                for (var s, i = t + "", a = 0; a < i.length;) e[o & a] = o & (s ^= 19 * e[o & a]) + i.charCodeAt(a++);
                return m(e)
            }
            ...
            e["seed" + a] = function(o, c, u) {
                var g = [],
                    y = d(f((c = !0 === c ? {
                        ...
                        try {
                            ...
                            return (s.crypto || s.msCrypto).getRandomValues(e), m(e)
                        } catch (e) {
                            var a = s.navigator,
                                r = a && a.plugins;
                            return [+new Date, s, r, s.screen, m(t)]
                        }
                    }() : o, 3), g),
                    v = new l(g),
                    b = function() {
                        for (var t = v.g(6), e = r, s = 0; t < n;) t = (t + s) * i, e *= i, s = v.g(1);
                        for (; t >= h;) t /= 2, e /= 2, s >>>= 1;
                        return (t + s) / e
                    };
                ...
                }, b.double = b, d(m(v.S), t), (c.pass || u || function(t, s, i, r) {
                    return r && (r.S && p(r, v), t.state = function() {
                        return p(v, {})
                    }), i ? (e[a] = t, s) : t
        ...
        var B = function() {
            ...
            function o(t, e, s) {
                return ((r(e, s) * t + n(e, s)) * t + h(e)) * t
            }

            function l(t, e, s) {
                return 3 * r(e, s) * t * t + 2 * n(e, s) * t + h(e)
            }

            function p(t) {
                this._p = t, this._mSampleValues = a ? new Float32Array(s) : new Array(s), this._precomputed = !1, this.get = this.get.bind(this)
            }
            return p.prototype = {
                get: function(t) {
                    var e = this._p[0],
                        ...
                        i = this._p[2],
                        a = this._p[3];
                    return this._precomputed || this._precompute(), e === s && i === a ? t : 0 === t ? 0 : 1 === t ? 1 : o(this._getTForX(t), s, a)
                },
                ...
                _calcSampleValues: function() {
                    for (var t = this._p[0], e = this._p[2], a = 0; a < s; ++a) this._mSampleValues[a] = o(a * i, t, e)
                },
                _getTForX: function(t) {
                    for (var e = this._p[0], a = this._p[2], r = this._mSampleValues, n = 0, h = 1, p = s - 1; h !== p && r[h] <= t; ++h) n += i;
                    var f = n + (t - r[--h]) / (r[h + 1] - r[h]) * i,
                        d = l(f, e, a);
                    return d >= .001 ? function(t, e, s, i) {
                        for (var a = 0; a < 4; ++a) {
                            var r = l(e, s, i);
                            if (0 === r) return e;
                            e -= (o(e, s, i) - t) / r
                        ...
                        return e
                    }(t, f, e, a) : 0 === d ? f : function(t, e, s, i, a) {
                        var r, n, h = 0;
                        do {
                            (r = o(n = e + (s - e) / 2, i, a) - t) > 0 ? s = n : e = n
        ...
        var X = function() {
                ...
                var s = function(t, e, s, i) {
                    var a, r, n, h, p, f, d = m,
                        ...
                        g = [],
                        y = Ct.newElement();
                    for (n = s.length, a = 0; a < d; a += 1) {
                        for (p = a / (d - 1), f = 0, r = 0; r < n; r += 1) h = o(1 - p, 3) * t[r] + 3 * o(1 - p, 2) * p * s[r] + 3 * (1 - p) * o(p, 2) * i[r] + o(p, 3) * e[r], u[r] = h, null !== g[r] && (f += o(u[r] - g[r], 2)), g[r] = u[r];
                        f && (c += f = l(f)), y.percents[a] = p, y.lengths[a] = c
                    }
                ...
                var r, n = (r = {}, function(t, s, n, h) {
                    var p = (t[0] + "_" + t[1] + "_" + s[0] + "_" + s[1] + "_" + n[0] + "_" + n[1] + "_" + h[0] + "_" + h[1]).replace(/\./g, "p");
                    if (!r[p]) {
                        var f, d, c, u, g, y, v, b = m,
                            _ = 0,
                            k = null;
                        2 === t.length && (t[0] !== s[0] || t[1] !== s[1]) && e(t[0], t[1], s[0], s[1], t[0] + n[0], t[1] + n[1]) && e(t[0], t[1], s[0], s[1], s[0] + h[0], s[1] + h[1]) && (b = 2);
                        var A = new i(b);
                        for (c = n.length, f = 0; f < b; f += 1) {
                            for (v = M(c), g = f / (b - 1), y = 0, d = 0; d < c; d += 1) u = o(1 - g, 3) * t[d] + 3 * o(1 - g, 2) * g * (t[d] + n[d]) + 3 * (1 - g) * o(g, 2) * (s[d] + h[d]) + o(g, 3) * s[d], v[d] = u, null !== k && (y += o(v[d] - k[d], 2));
                            _ += y = l(y), A.points[f] = new a(y, v), k = v
                        }
                ...
                function h(t, e) {
                    ...
                    for (var o = i[r] > n ? -1 : 1, l = !0; l;)
                        if (i[r] <= n && i[r + 1] > n ? (h = (n - i[r]) / (i[r + 1] - i[r]), l = !1) : r += o, r < 0 || r >= a - 1) {
                            if (r === a - 1) return s[r];
                            l = !1
                        }
                ...
                return {
                    ...
                    getNewSegment: function(e, s, i, a, r, n, o) {
                        ...
                        var l, p = h(r, o),
                            ...
                            T = d * d * u + u * d * d + d * u * d,
                            E = d * d * d;
                        for (l = 0; l < m; l += 1) f[4 * l] = t.round(1e3 * (g * e[l] + y * i[l] + v * a[l] + b * s[l])) / 1e3, f[4 * l + 1] = t.round(1e3 * (_ * e[l] + k * i[l] + A * a[l] + P * s[l])) / 1e3, f[4 * l + 2] = t.round(1e3 * (D * e[l] + S * i[l] + x * a[l] + C * s[l])) / 1e3, f[4 * l + 3] = t.round(1e3 * (w * e[l] + F * i[l] + T * a[l] + E * s[l])) / 1e3;
                        return f
                    },
                    getPointInSegment: function(e, s, i, a, r, n) {
                        var o = h(r, n),
                            l = 1 - o;
                        return [t.round(1e3 * (l * l * l * e[0] + (o * l * l + l * o * l + l * l * o) * i[0] + (o * o * l + l * o * o + o * l * o) * a[0] + o * o * o * s[0])) / 1e3, t.round(1e3 * (l * l * l * e[1] + (o * l * l + l * o * l + l * l * o) * i[1] + (o * o * l + l * o * o + o * l * o) * a[1] + o * o * o * s[1])) / 1e3]
                    },
                    buildBezierData: n,
                    pointOnLine2D: e,
        ...
        var G = function() {
                ...
                function r(t, e) {
                    ...
                    var i = Y(e);
                    return s.setAttribute("font-family", e.fFamily), s.setAttribute("font-style", i.style), s.setAttribute("font-weight", i.weight), s.textContent = "1", e.fClass ? (s.style.fontFamily = "inherit", s.setAttribute("class", e.fClass)) : s.style.fontFamily = e.fFamily, t.appendChild(s), L("canvas").getContext("2d").font = e.fWeight + " " + e.fStyle + " 100px " + e.fFamily, s
                }
                var n = function() {
            ...
            J = function() {
                ...
                function s(t, e) {
                    ...
                    "multidimensional" === this.propType && (s = E("float32", this.pv.length));
                    for (var r, n, h, o, l, p, f, d, m = e.lastIndex, u = m, g = this.keyframes.length - 1, y = !0; y;) {
                    ...
                    var v, b, _, k, A, P, D, S, x, C, w = n.t - a,
                        F = r.t - a;
                    if (r.to) {
                        r.bezierData || (r.bezierData = X.buildBezierData(r.s, n.s || r.e, r.to, r.ti));
                        var T = r.bezierData;
                        if (t >= w || t < F) {
                            var M = t >= w ? T.points.length - 1 : 0;
                            for (o = T.points[M].point.length, h = 0; h < o; h += 1) s[h] = T.points[M].point[h]
                        } else {
                            r.__fnct ? d = r.__fnct : (d = B.getBezierEasing(r.o.x, r.o.y, r.i.x, r.i.y, r.n).get, r.__fnct = d), l = d((t - F) / (w - F));
                            var I, L = T.segmentLength * l,
                                V = e.lastFrame < t && e._lastKeyframeIndex === u ? e._lastAddedLength : 0;
                            for (f = e.lastFrame < t && e._lastKeyframeIndex === u ? e._lastPoint : 0, y = !0, p = T.points.length; y;) {
                                if (V += T.points[f].partialLength, 0 === L || 0 === l || f === T.points.length - 1) {
                                    for (o = T.points[f].point.length, h = 0; h < o; h += 1) s[h] = T.points[f].point[h];
                                    break
                                }
                                if (L >= V && L < V + T.points[f + 1].partialLength) {
                                    for (I = (L - V) / T.points[f + 1].partialLength, o = T.points[f].point.length, h = 0; h < o; h += 1) s[h] = T.points[f].point[h] + (T.points[f + 1].point[h] - T.points[f].point[h]) * I;
                                    break
                                }
                                f < p - 1 ? f += 1 : y = !1
                            }
                            e._lastPoint = f, e._lastAddedLength = V - T.points[f].partialLength, e._lastKeyframeIndex = u
                        }
                    } else {
                        var R, z, N, O, q;
                        if (g = r.s.length, v = n.s || r.e, this.sh && 1 !== r.h)
                            ...
                            }(j, W, (t - F) / (w - F)), k = _[0], A = _[1], P = _[2], D = _[3], S = Math.atan2(2 * A * D - 2 * k * P, 1 - 2 * A * A - 2 * P * P), x = Math.asin(2 * k * A + 2 * P * D), C = Math.atan2(2 * k * D - 2 * A * P, 1 - 2 * k * k - 2 * P * P), b[0] = S / c, b[1] = x / c, b[2] = C / c
                        } else
                            for (u = 0; u < g; u += 1) 1 !== r.h && (t >= w ? l = 1 : t < F ? l = 0 : (r.o.x.constructor === Array ? (r.__fnct || (r.__fnct = []), r.__fnct[u] ? d = r.__fnct[u] : (R = void 0 === r.o.x[u] ? r.o.x[0] : r.o.x[u], z = void 0 === r.o.y[u] ? r.o.y[0] : r.o.y[u], N = void 0 === r.i.x[u] ? r.i.x[0] : r.i.x[u], O = void 0 === r.i.y[u] ? r.i.y[0] : r.i.y[u], d = B.getBezierEasing(R, z, N, O).get, r.__fnct[u] = d)) : r.__fnct ? d = r.__fnct : (R = r.o.x, z = r.o.y, N = r.i.x, O = r.i.y, d = B.getBezierEasing(R, z, N, O).get, r.__fnct = d), l = d((t - F) / (w - F)))), v = n.s || r.e, q = 1 === r.h ? r.s[u] : r.s[u] + (v[u] - r.s[u]) * l, "multidimensional" === this.propType ? s[u] = q : s = q
                    }
                ...
                function p(t, e, s, i) {
                    ...
                    var r = e.k.length;
                    for (this.v = E("float32", r), this.pv = E("float32", r), this.vel = E("float32", r), a = 0; a < r; a += 1) this.v[a] = e.k[a] * this.mult, this.pv[a] = e.k[a];
                ...
                function d(e, i, a, l) {
                    ...
                    for (p = 0; p < u - 1; p += 1) i.k[p].to && i.k[p].s && i.k[p + 1] && i.k[p + 1].s && (f = i.k[p].s, d = i.k[p + 1].s, m = i.k[p].to, c = i.k[p].ti, (2 === f.length && (f[0] !== d[0] || f[1] !== d[1]) && X.pointOnLine2D(f[0], f[1], d[0], d[1], f[0] + m[0], f[1] + m[1]) && X.pointOnLine2D(f[0], f[1], d[0], d[1], d[0] + c[0], d[1] + c[1]) || 3 === f.length && (f[0] !== d[0] || f[1] !== d[1] || f[2] !== d[2]) && X.pointOnLine3D(f[0], f[1], f[2], d[0], d[1], d[2], f[0] + m[0], f[1] + m[1], f[2] + m[2]) && X.pointOnLine3D(f[0], f[1], f[2], d[0], d[1], d[2], d[0] + c[0], d[1] + c[1], d[2] + c[2])) && (i.k[p].to = null, i.k[p].ti = null), f[0] === d[0] && f[1] === d[1] && 0 === m[0] && 0 === m[1] && 0 === c[0] && 0 === c[1] && (2 === f.length || f[2] === d[2] && 0 === m[2] && 0 === c[2]) && (i.k[p].to = null, i.k[p].ti = null));
                    ...
                    for (this.v = E("float32", g), this.pv = E("float32", g), p = 0; p < g; p += 1) this.v[p] = t, this.pv[p] = t;
                    this._caching = {
                        lastFrame: t,
                        lastIndex: 0,
                        value: E("float32", g)
            ...
            K = function() {
                ...
                function e(t, e, s) {
                    if (this.elem = t, this.frameId = -1, this.propType = "transform", this.data = e, this.v = new q, this.pre = new q, this.appliedTransformations = 0, this.initDynamicPropertyContainer(s || t), e.p && e.p.s ? (this.px = J.getProp(t, e.p.x, 0, 0, this), this.py = J.getProp(t, e.p.y, 0, 0, this), e.p.z && (this.pz = J.getProp(t, e.p.z, 0, 0, this))) : this.p = J.getProp(t, e.p || {
                            k: [0, 0, 0]
                        }, 1, 0, this), e.rx) {
                        if (this.rx = J.getProp(t, e.rx, 0, c, this), this.ry = J.getProp(t, e.ry, 0, c, this), this.rz = J.getProp(t, e.rz, 0, c, this), e.or.k[0].ti) {
                            var i, a = e.or.k.length;
                            for (i = 0; i < a; i += 1) e.or.k[i].to = null, e.or.k[i].ti = null
                        }
                        this.or = J.getProp(t, e.or, 1, c, this), this.or.sh = !0
                    } else this.r = J.getProp(t, e.r || {
                        k: 0
                    }, 0, c, this);
                    e.sk && (this.sk = J.getProp(t, e.sk, 0, c, this), this.sa = J.getProp(t, e.sa, 0, c, this)), this.a = J.getProp(t, e.a || {
                        k: [0, 0, 0]
                    }, 1, 0, this), this.s = J.getProp(t, e.s || {
                        k: [100, 100, 100]
                    }, 1, .01, this), e.o ? this.o = J.getProp(t, e.o, 0, .01, t) : this.o = {
                        _mdf: !1,
                        v: 1
                ...
                return e.prototype = {
                    ...
                    autoOrient: function() {}
                }, j([V], e), e.prototype.addDynamicProperty = function(t) {
                    this._addDynamicProperty(t), this.elem.addDynamicProperty(t), this._isDirty = !0
                }, e.prototype._addDynamicProperty = V.prototype.addDynamicProperty, {
        ...
        U.prototype.setPathData = function(t, e) {
            ...
            for (var s = 0; s < e;) this.v[s] = Pt.newElement(), this.o[s] = Pt.newElement(), this.i[s] = Pt.newElement(), s += 1
            ...
            switch (this._length = Math.max(this._length, i + 1), this._length >= this._maxLength && this.doubleArrayLength(), s) {
                ...
                default:
                    r = []
            }(!r[i] || r[i] && !a) && (r[i] = Pt.newElement()), r[i][0] = t, r[i][1] = e
        ...
        var Z, Q, $ = function() {
                    ...
                    if (t < m[0].t - this.offsetTime) i = m[0].s[0], r = !0, d = 0;
                        ...
                        if (d = g, !(r = 1 === c.h)) {
                            if (t >= u.t - this.offsetTime) p = 1;
                                ...
                                var b;
                                c.__fnct ? b = c.__fnct : (b = B.getBezierEasing(c.o.x, c.o.y, c.i.x, c.i.y).get, c.__fnct = b), p = b((t - (c.t - this.offsetTime)) / (u.t - this.offsetTime - (c.t - this.offsetTime)))
                            }
                            a = u.s ? u.s[0] : c.e[0]
                        }
                        i = c.s[0]
                ...
                function a(t) {
                    (function(t, e) {
                        ...
                        return !0
                    })(this.v, t) || (this.v = Dt.clone(t), this.localShapeCollection.releaseShapes(), this.localShapeCollection.addShape(this.v), this._mdf = !0, this.paths = this.localShapeCollection)
                }
                ...
                function n(t, e, s) {
                    ...
                    this.v = Dt.clone(a), this.pv = Dt.clone(this.v), this.localShapeCollection = St.newShapeCollection(), this.paths = this.localShapeCollection, this.paths.addShape(this.v), this.reset = i, this.effectsSequence = []
                }
                ...
                function o(e, a, r) {
                    ...
                    this.v = Dt.newElement(), this.v.setPathData(this.keyframes[0].s[0].c, n), this.pv = Dt.clone(this.v), this.localShapeCollection = St.newShapeCollection(), this.paths = this.localShapeCollection, this.paths.addShape(this.v), this.lastFrame = t, this.reset = i, this._caching = {
                        lastFrame: t,
                        lastIndex: 0
                ...
                var l = function() {
                        ...
                        function e(t, e) {
                            this.v = Dt.newElement(), this.v.setPathData(!0, 4), this.localShapeCollection = St.newShapeCollection(), this.paths = this.localShapeCollection, this.localShapeCollection.addShape(this.v), this.d = e.d, this.elem = t, this.comp = t.comp, this.frameId = -1, this.initDynamicPropertyContainer(t), this.p = J.getProp(t, e.p, 1, 0, this), this.s = J.getProp(t, e.s, 1, 0, this), this.dynamicProperties.length ? this.k = !0 : (this.k = !1, this.convertEllToPath())
                        }
                        return e.prototype = {
                            reset: i,
                            getValue: function() {
                    ...
                    d = function() {
                        function t(t, e) {
                            this.v = Dt.newElement(), this.v.c = !0, this.localShapeCollection = St.newShapeCollection(), this.localShapeCollection.addShape(this.v), this.paths = this.localShapeCollection, this.elem = t, this.comp = t.comp, this.frameId = -1, this.d = e.d, this.initDynamicPropertyContainer(t), this.p = J.getProp(t, e.p, 1, 0, this), this.s = J.getProp(t, e.s, 1, 0, this), this.r = J.getProp(t, e.r, 0, 0, this), this.dynamicProperties.length ? this.k = !0 : (this.k = !1, this.convertRectToPath())
                        }
                        return t.prototype = {
                    ...
                    m = {
                        getShapeProp: function(t, e, s) {
                            var i;
                            return 3 === s || 4 === s ? i = (3 === s ? e.pt : e.ks).k.length ? new o(t, e, s) : new n(t, e, s) : 5 === s ? i = new d(t, e) : 6 === s ? i = new l(t, e) : 7 === s && (i = new p(t, e)), i.k && t.addDynamicProperty(i), i
                        },
            ...
            tt = (Q = {}, (Z = {}).registerModifier = function(t, e) {
                Q[t] || (Q[t] = e)
            }, Z.getModifier = function(t, e, s) {
                return new Q[t](e, s)
            }, Z);
        ...
        function ht(t, e, s, i) {
            var a;
            this.elem = t, this.frameId = -1, this.dataProps = M(e.length), this.renderer = s, this.k = !1, this.dashStr = "", this.dashArray = E("float32", e.length ? e.length - 1 : 0), this.dashoffset = E("float32", 1), this.initDynamicPropertyContainer(i);
            var r, n = e.length || 0;
            for (a = 0; a < n; a += 1) r = J.getProp(t, e[a].v, 0, 0, this), this.k = r.k || this.k, this.dataProps[a] = {
                n: e[a].n,
                p: r
            };
        ...
        function ot(t, e, s) {
            this.data = e, this.c = E("uint8c", 4 * e.p);
            var i = e.k.k[0].s ? e.k.k[0].s.length - 4 * e.p : e.k.k.length - 4 * e.p;
            this.o = E("float32", i), this._cmdf = !1, this._omdf = !1, this._collapsable = this.checkCollapsable(), this._hasOpacity = i, this.initDynamicPropertyContainer(s), this.prop = J.getProp(t, e.k, 1, null, this), this.k = this.prop.k, this.getValue(!0)
        }
        et.prototype.initModifierProperties = function() {}, et.prototype.addShapeToModifier = function() {}, et.prototype.addShape = function(t) {
            if (!this.closed) {
                t.sh.container.addDynamicProperty(t.sh);
                var e = {
                    shape: t.sh,
                    data: t,
                    localShapeCollection: St.newShapeCollection()
                };
                this.shapes.push(e), this.addShapeToModifier(e), this._isAnimated && t.setAsAnimated()
            }
        }, et.prototype.init = function(t, e) {
        ...
        }, et.prototype.processKeys = function() {
            this.elem.globalData.frameId !== this.frameId && (this.frameId = this.elem.globalData.frameId, this.iterateDynamicProperties())
        }, j([V], et), j([et], st), st.prototype.initModifierProperties = function(t, e) {
            this.s = J.getProp(t, e.s, 0, .01, this), this.e = J.getProp(t, e.e, 0, .01, this), this.o = J.getProp(t, e.o, 0, 0, this), this.sValue = 0, this.eValue = 0, this.getValue = this.processKeys, this.m = e.m, this._isAnimated = !!this.s.effectsSequence.length || !!this.e.effectsSequence.length || !!this.o.effectsSequence.length
                ...
                for (a = 0; a < d; a += 1)
                    if ((c = this.shapes[a]).shape._mdf || this._mdf || t || 2 === this.m) {
                        if (o = (i = c.shape.paths)._length, f = 0, !c.shape._mdf && c.pathsData.length) f = c.totalShapeLength;
                            ...
                            for (l = this.releasePathsData(c.pathsData), h = 0; h < o; h += 1) p = X.getSegmentsLength(i.shapes[h]), l.push(p), f += p.totalLength;
            ...
            var i, a, r, n, h, o, l, p, f = t.pathsData,
                ...
                u = [],
                g = !0;
            for (s ? (h = s._length, p = s._length) : (s = Dt.newElement(), h = 0, p = 0), u.push(s), i = 0; i < m; i += 1) {
                for (o = f[i].lengths, s.c = d[i].c, r = d[i].c ? o.length : o.length + 1, a = 1; a < r; a += 1)
                    if (c + (n = o[a - 1]).addedLength < e.s) c += n.addedLength, s.c = !1;
                        ...
                        e.s <= c && e.e >= c + n.addedLength ? (this.addSegment(d[i].v[a - 1], d[i].o[a - 1], d[i].i[a], d[i].v[a], s, h, g), g = !1) : (l = X.getNewSegment(d[i].v[a - 1], d[i].v[a], d[i].o[a - 1], d[i].i[a], (e.s - c) / n.addedLength, (e.e - c) / n.addedLength, o[a - 1]), this.addSegmentFromArray(l, s, h, g), g = !1, s.c = !1), c += n.addedLength, h += 1
                    }
                if (d[i].c && o.length) {
                    if (n = o[a - 1], c <= e.e) {
                        var y = o[a - 1].addedLength;
                        e.s <= c && e.e >= c + y ? (this.addSegment(d[i].v[a - 1], d[i].o[a - 1], d[i].i[0], d[i].v[0], s, h, g), g = !1) : (l = X.getNewSegment(d[i].v[a - 1], d[i].v[0], d[i].o[a - 1], d[i].i[0], (e.s - c) / y, (e.e - c) / y, o[a - 1]), this.addSegmentFromArray(l, s, h, g), g = !1, s.c = !1)
                    } else s.c = !1;
                    c += n.addedLength, h += 1
                }
            ...
            return u
        }, tt.registerModifier("tm", st), j([et], it), it.prototype.initModifierProperties = function(t, e) {
            ...
            i.c = t.c;
            var a, r, n, h, o, l, p, f, d, m, c, g, y = t._length,
                v = 0;
            for (s = 0; s < y; s += 1) a = t.v[s], n = t.o[s], r = t.i[s], a[0] === n[0] && a[1] === n[1] && a[0] === r[0] && a[1] === r[1] ? 0 !== s && s !== y - 1 || t.c ? (h = 0 === s ? t.v[y - 1] : t.v[s - 1], l = (o = Math.sqrt(Math.pow(a[0] - h[0], 2) + Math.pow(a[1] - h[1], 2))) ? Math.min(o / 2, e) / o : 0, p = c = a[0] + (h[0] - a[0]) * l, f = g = a[1] - (a[1] - h[1]) * l, d = p - (p - a[0]) * u, m = f - (f - a[1]) * u, i.setTripleAt(p, f, d, m, c, g, v), v += 1, h = s === y - 1 ? t.v[0] : t.v[s + 1], l = (o = Math.sqrt(Math.pow(a[0] - h[0], 2) + Math.pow(a[1] - h[1], 2))) ? Math.min(o / 2, e) / o : 0, p = d = a[0] + (h[0] - a[0]) * l, f = m = a[1] + (h[1] - a[1]) * l, c = p - (p - a[0]) * u, g = f - (f - a[1]) * u, i.setTripleAt(p, f, d, m, c, g, v), v += 1) : (i.setTripleAt(a[0], a[1], n[0], n[1], r[0], r[1], v), v += 1) : (i.setTripleAt(t.v[s][0], t.v[s][1], t.o[s][0], t.o[s][1], t.i[s][0], t.i[s][1], v), v += 1);
            return i
        ...
        }, tt.registerModifier("rd", it), j([et], at), at.prototype.initModifierProperties = function(t, e) {
        ...
        }, at.prototype.processPath = function(t, e) {
            var s = e / 100,
                i = [0, 0],
                a = t._length,
                r = 0;
            ...
            this.dynamicProperties.length || (this._mdf = !1)
        }, tt.registerModifier("pb", at), j([et], rt), rt.prototype.initModifierProperties = function(t, e) {
            this.getValue = this.processKeys, this.c = J.getProp(t, e.c, 0, null, this), this.o = J.getProp(t, e.o, 0, null, this), this.tr = K.getTransformProperty(t, e.tr, this), this.so = J.getProp(t, e.tr.so, 0, .01, this), this.eo = J.getProp(t, e.tr.eo, 0, .01, this), this.data = e, this.dynamicProperties.length || this.getValue(!0), this._isAnimated = !!this.dynamicProperties.length, this.pMatrix = new q, this.rMatrix = new q, this.sMatrix = new q, this.tMatrix = new q, this.matrix = new q
        }, rt.prototype.applyTransforms = function(t, e, s, i, a, r) {
            var n = r ? -1 : 1,
        ...
        }, rt.prototype.init = function(t, e, s, i) {
            ...
            return n
        }, rt.prototype.addShape = function() {}, tt.registerModifier("rp", rt), nt.prototype.addShape = function(t) {
        ...
        }, j([V], ht), ot.prototype.comparePoints = function(t, e) {
            for (var s = 0, i = this.o.length / 2; s < i;) {
                if (Math.abs(t[4 * s] - t[4 * e + 2 * s]) > .01) return !1;
                s += 1
            }
            return !0
        }, ot.prototype.checkCollapsable = function() {
        ...
        function ut(t, e, s) {
            this._isFirstFrame = !0, this._hasMaskedPath = !1, this._frameId = -1, this._textData = t, this._renderType = e, this._elem = s, this._animatorsData = M(this._textData.a.length), this._pathData = {}, this._moreOptions = {
                alignment: {}
        ...
        ut.prototype.searchProperties = function() {
            var t, e, s = this._textData.a.length,
                i = J.getProp;
            for (t = 0; t < s; t += 1) e = this._textData.a[t], this._animatorsData[t] = new gt(this._elem, e, this);
        ...
        }, ut.prototype.getMeasures = function(t, e) {
            if (this.lettersChangedFlag = e, this._mdf || this._isFirstFrame || e || this._hasMaskedPath && this._pathData.m._mdf) {
                ...
                if (this._hasMaskedPath) {
                    if (_ = this._pathData.m, !this._pathData.n || this._pathData._mdf) {
                        ...
                        for (this._pathData.r.v && (M = M.reverse()), n = {
                                tLength: 0,
                                segments: []
                            }, r = M._length - 1, y = 0, a = 0; a < r; a += 1) E = X.buildBezierData(M.v[a], M.v[a + 1], [M.o[a][0] - M.v[a][0], M.o[a][1] - M.v[a][1]], [M.i[a + 1][0] - M.v[a + 1][0], M.i[a + 1][1] - M.v[a + 1][1]]), n.tLength += E.segmentLength, n.segments.push(E), y += E.segmentLength;
                        a = r, _.v.c && (E = X.buildBezierData(M.v[a], M.v[0], [M.o[a][0] - M.v[a][0], M.o[a][1] - M.v[a][1]], [M.i[0][0] - M.v[0][0], M.i[0][1] - M.v[0][1]]), n.tLength += E.segmentLength, n.segments.push(E), y += E.segmentLength), this._pathData.pi = n
                    }
                ...
                for (a = 0; a < r; a += 1) {
                    if (D.reset(), W = 1, T[a].n) s = 0, i += t.yOffset, i += O ? 1 : 0, h = tt, O = !1, this._hasMaskedPath && (f = st, m = (c = u[d = et].points)[f - 1], g = (o = c[f]).partialLength, l = 0), at = "", Z = "", K = "", Q = "", rt = this.defaultPropsArray;
                    else {
                        if (this._hasMaskedPath) {
                            if (it !== T[a].line) {
                                switch (t.j) {
                        ...
                        for (L = 0; L < V; L += 1) {
                            ...
                            if (t.fillColorAnim && t.fc) {
                                ...
                                I.fh.propType && (G = z.length ? F(G, I.fh.v * z[0]) : F(G, I.fh.v * z)), I.fs.propType && (G = z.length ? C(G, I.fs.v * z[0]) : C(G, I.fs.v * z)), I.fb.propType && (G = z.length ? w(G, I.fb.v * z[0]) : w(G, I.fb.v * z))
                            }
                        }
                        ...
                        "html" === S ? at = D.toCSS() : "svg" === S ? at = D.to2dCSS() : rt = [D.props[0], D.props[1], D.props[2], D.props[3], D.props[4], D.props[5], D.props[6], D.props[7], D.props[8], D.props[9], D.props[10], D.props[11], D.props[12], D.props[13], D.props[14], D.props[15]], Q = W
                    }
                    x <= a ? (R = new yt(Q, K, U, Z, at, rt), this.renderedLetters.push(R), x += 1, this.lettersChangedFlag = !0) : (R = this.renderedLetters[a], this.lettersChangedFlag = R.update(Q, K, U, Z, at, rt) || this.lettersChangedFlag)
                }
            }
        }, ut.prototype.getValue = function() {
            this._elem.globalData.frameId !== this._frameId && (this._frameId = this._elem.globalData.frameId, this.iterateDynamicProperties())
        }, ut.prototype.mHelper = new q, ut.prototype.defaultPropsArray = [], j([V], ut), yt.prototype.update = function(t, e, s, i, a, r) {
            ...
            for (var e, s, i = [], a = 0, r = t.length, n = !1; a < r;) e = t.charCodeAt(a), G.isCombinedCharacter(e) ? i[i.length - 1] += t.charAt(a) : e >= 55296 && e <= 56319 ? (s = t.charCodeAt(a + 1)) >= 56320 && s <= 57343 ? (n || G.isModifier(e, s) ? (i[i.length - 1] += t.substr(a, 2), n = !1) : i.push(t.substr(a, 2)), a += 1) : i.push(t.charAt(a)) : e > 56319 ? (s = t.charCodeAt(a + 1), G.isZeroWidthJoiner(e, s) ? (n = !0, i[i.length - 1] += t.substr(a, 2), a += 1) : i.push(t.charAt(a))) : G.isZeroWidthJoiner(e) ? (i[i.length - 1] += t.charAt(a), n = !0) : i.push(t.charAt(a)), a += 1;
            return i
        ...
        var bt, _t = function() {
                ...
                function i(t, e) {
                    this._currentTextLength = -1, this.k = !1, this.data = e, this.elem = t, this.comp = t.comp, this.finalS = 0, this.finalE = 0, this.initDynamicPropertyContainer(t), this.s = J.getProp(t, e.s || {
                        k: 0
                    }, 0, 0, this), this.e = "e" in e ? J.getProp(t, e.e, 0, 0, this) : {
                        v: 100
                    }, this.o = J.getProp(t, e.o || {
                        k: 0
                    }, 0, 0, this), this.xe = J.getProp(t, e.xe || {
                        k: 0
                    }, 0, 0, this), this.ne = J.getProp(t, e.ne || {
                        k: 0
                    }, 0, 0, this), this.sm = J.getProp(t, e.sm || {
                        k: 100
                    }, 0, 0, this), this.a = J.getProp(t, e.a, 0, .01, this), this.dynamicProperties.length || this.getValue()
                }
                return i.prototype = {
                    getMult: function(i) {
                        ...
                        var o = B.getBezierEasing(a, r, n, h).get,
                            l = 0,
                            p = this.finalS,
                            f = this.finalE,
                            d = this.data.sh;
            ...
            kt = function(t, e, s) {
                ...
                return {
                    ...
                    release: function(t) {
                        i === a && (r = At.double(r), a *= 2), s && s(t), r[i] = t, i += 1
                    }
                }
            },
            At = {
            ...
            Dt = ((bt = kt(4, (function() {
                ...
                var e, s = t._length;
                for (e = 0; e < s; e += 1) Pt.release(t.v[e]), Pt.release(t.i[e]), Pt.release(t.o[e]), t.v[e] = null, t.i[e] = null, t.o[e] = null;
                t._length = 0, t.c = !1
            }))).clone = function(t) {
                var e, s = bt.newElement(),
            ...
            St = function() {
                var t = {
                        newShapeCollection: function() {
                            return e ? i[e -= 1] : new nt
                        },
                        release: function(t) {
                            var a, r = t._length;
                            for (a = 0; a < r; a += 1) Dt.release(t.shapes[a]);
                            t._length = 0, e === s && (i = At.double(i), s *= 2), i[e] = t, e += 1
                        }
                    },
                    e = 0,
                    s = 4,
        ...
        function Et(t, e, s) {
            ...
            this.viewData = M(h), this.solidPath = "";
            var o, l, p, f, d, m, c = this.masksProperties,
                ...
                b = "clip-path";
            for (a = 0; a < h; a += 1)
                if (("a" !== c[a].mode && "n" !== c[a].mode || c[a].inv || 100 !== c[a].o.k || c[a].o.x) && (v = "mask", b = "mask"), "s" !== c[a].mode && "i" !== c[a].mode || 0 !== u ? p = null : ((p = I("rect")).setAttribute("fill", "#ffffff"), p.setAttribute("width", this.element.comp.data.w || 0), p.setAttribute("height", this.element.comp.data.h || 0), g.push(p)), r = I("path"), "n" === c[a].mode) this.viewData[a] = {
                    op: J.getProp(this.element, c[a].o, 0, .01, this.element),
                    prop: $.getShapeProp(this.element, c[a], 3),
                    elem: r,
                    lastPath: ""
                }, n.appendChild(r);
                else {
                    ...
                    if (u += 1, r.setAttribute("fill", "s" === c[a].mode ? "#000000" : "#ffffff"), r.setAttribute("clip-rule", "nonzero"), 0 !== c[a].x.k ? (v = "mask", b = "mask", m = J.getProp(this.element, c[a].x, 0, null, this.element), _ = D(), (f = I("filter")).setAttribute("id", _), (d = I("feMorphology")).setAttribute("operator", "erode"), d.setAttribute("in", "SourceGraphic"), d.setAttribute("radius", "0"), f.appendChild(d), n.appendChild(f), r.setAttribute("stroke", "s" === c[a].mode ? "#000000" : "#ffffff")) : (d = null, m = null), this.storedData[a] = {
                        ...
                        var A = I("mask");
                        A.setAttribute("mask-type", "alpha"), A.setAttribute("id", y + "_" + u), A.appendChild(r), n.appendChild(A), k.setAttribute("mask", "url(" + i + "#" + y + "_" + u + ")"), g.length = 0, g.push(k)
                    } else g.push(r);
            ...
            for (this.maskElement = I(v), h = g.length, a = 0; a < h; a += 1) this.maskElement.appendChild(g[a]);
            u > 0 && (this.maskElement.setAttribute("id", y), this.element.maskedElement.setAttribute(b, "url(" + i + "#" + y + ")"), n.appendChild(this.maskElement)), this.viewData.length && this.element.addRenderableComponent(this)
        }
        ...
        function Bt(t, e, s) {
            this.initDynamicPropertyContainer(t), this.getValue = this.iterateDynamicProperties, this.o = J.getProp(t, e.o, 0, .01, this), this.w = J.getProp(t, e.w, 0, null, this), this.d = new ht(t, e.d || {}, "svg", this), this.c = J.getProp(t, e.c, 1, 255, this), this.style = s, this._isAnimated = !!this._isAnimated
        }

        function jt(t, e, s) {
            this.initDynamicPropertyContainer(t), this.getValue = this.iterateDynamicProperties, this.o = J.getProp(t, e.o, 0, .01, this), this.c = J.getProp(t, e.c, 1, 255, this), this.style = s
        }
        ...
        function Xt(t, e, s) {
            this.initDynamicPropertyContainer(t), this.getValue = this.iterateDynamicProperties, this.w = J.getProp(t, e.w, 0, null, this), this.d = new ht(t, e.d || {}, "svg", this), this.initGradientData(t, e, s), this._isAnimated = !!this._isAnimated
        }
        ...
        Ft.prototype.checkLayers = function(t) {
        ...
        }, Ft.prototype.createAudio = function(t) {
            return new ee(t, this.globalData, this)
        }, Ft.prototype.createFootage = function(t) {
        ...
        }, j([Ft], Tt), Tt.prototype.createNull = function(t) {
            return new Jt(t, this.globalData, this)
        }, Tt.prototype.createShape = function(t) {
            return new ae(t, this.globalData, this)
        }, Tt.prototype.createText = function(t) {
            return new ie(t, this.globalData, this)
        }, Tt.prototype.createImage = function(t) {
            return new $t(t, this.globalData, this)
        }, Tt.prototype.createComp = function(t) {
            return new se(t, this.globalData, this)
        }, Tt.prototype.createSolid = function(t) {
            return new te(t, this.globalData, this)
        }, Tt.prototype.configAnimation = function(t) {
            ...
            var r = D();
            s.setAttribute("id", r), s.appendChild(a), this.layerElement.setAttribute("clip-path", "url(" + i + "#" + r + ")"), e.appendChild(s), this.layers = t.layers, this.elements = M(t.layers.length)
        ...
        }, Tt.prototype.updateContainerSize = function() {}, Tt.prototype.buildItem = function(t) {
            var s = this.elements;
        ...
        }, Tt.prototype.checkPendingElements = function() {
        ...
        }, Tt.prototype.appendElementInPos = function(t, e) {
        ...
        }, Et.prototype.drawPath = function(t, e, s) {
            ...
            initTransform: function() {
                this.finalTransform = {
                    mProp: this.data.ks ? K.getTransformProperty(this, this.data.ks, this) : {
                        o: 0
                    },
                    _matMdf: !1,
                    _opMdf: !1,
        ...
        })], Rt), Nt.prototype.reset = function() {
            this.d = "", this._mdf = !1
        }, Ot.prototype.setAsAnimated = function() {
            this._isAnimated = !0
        }, j([V], Bt), j([V], jt), Wt.prototype.initGradientData = function(t, e, s) {
            this.o = J.getProp(t, e.o, 0, .01, this), this.s = J.getProp(t, e.s, 1, null, this), this.e = J.getProp(t, e.e, 1, null, this), this.h = J.getProp(t, e.h || {
                k: 0
            }, 0, .01, this), this.a = J.getProp(t, e.a || {
                k: 0
            }, 0, c, this), this.g = new ot(t, e.g, this), this.style = s, this.stops = [], this.setGradientData(s.pElem, e), this.setGradientOpacity(e, s), this._isAnimated = !!this._isAnimated
        }, Wt.prototype.setGradientData = function(t, e) {
            var s = D(),
                a = I(1 === e.t ? "linearGradient" : "radialGradient");
            a.setAttribute("id", s), a.setAttribute("spreadMethod", "pad"), a.setAttribute("gradientUnits", "userSpaceOnUse");
            var r, n, h, o = [];
            for (h = 4 * e.g.p, n = 0; n < h; n += 4) r = I("stop"), a.appendChild(r), o.push(r);
            t.setAttribute("gf" === e.ty ? "fill" : "stroke", "url(" + i + "#" + s + ")"), this.gf = a, this.cst = o
        }, Wt.prototype.setGradientOpacity = function(t, e) {
            if (this.g._hasOpacity && !this.g._collapsable) {
                ...
                var f = this.stops;
                for (a = 4 * t.g.p; a < r; a += 2)(s = I("stop")).setAttribute("stop-color", "rgb(255,255,255)"), p.appendChild(s), f.push(s);
                h.setAttribute("gf" === t.ty ? "fill" : "stroke", "url(" + i + "#" + o + ")"), "gs" === t.ty && (h.setAttribute("stroke-linecap", N[t.lc || 2]), h.setAttribute("stroke-linejoin", O[t.lj || 2]), 1 === t.lj && h.setAttribute("stroke-miterlimit", t.ml)), this.of = p, this.ms = n, this.ost = f, this.maskId = l, e.msElem = h
            }
        }, j([V], Wt), j([Wt, V], Xt);
        var Yt = function() {
            var t = new q,
            ...
            function i(s, i, a) {
                ...
                for (p = 0; p < g; p += 1) {
                    ...
                    if (n = (f = i.sh.paths)._length, o) {
                        for (h = "", r = 0; r < n; r += 1)(l = f.shapes[r]) && l._length && (h += lt(l, l._length, l.c, d));
                        i.caches[p] = h
                    } else h = i.caches[p];
            ...
            function a(t, e, s) {
                var i = e.style;
                (e.c._mdf || s) && i.pElem.setAttribute("fill", "rgb(" + p(e.c.v[0]) + "," + p(e.c.v[1]) + "," + p(e.c.v[2]) + ")"), (e.o._mdf || s) && i.pElem.setAttribute("fill-opacity", e.o.v)
            }
        ...
        function ee(t, e, s) {
            ...
            this.audio = this.globalData.audioController.createAudio(i), this._currentTime = 0, this.globalData.audioController.addAudio(this), this.tm = t.tm ? J.getProp(this, t.tm, 0, e.frameRate, this) : {
                _placeholder: !0
            }
        }

        function se(t, e, s) {
            this.layers = t.layers, this.supports3d = !0, this.completeLayers = !1, this.pendingElements = [], this.elements = this.layers ? M(this.layers.length) : [], this.initElement(t, e, s), this.tm = t.tm ? J.getProp(this, t.tm, 0, e.frameRate, this) : {
                _placeholder: !0
            }
        }
        ...
        Gt.prototype = {
            ...
            initBaseData: function(t, e, s) {
                this.globalData = e, this.comp = s, this.data = t, this.layerId = D(), this.data.sr || (this.data.sr = 1), this.effectsManager = new oe(this.data, this, this.dynamicProperties)
            },
            getType: function() {
                return this.type
            },
            ...
            return null
        }, Jt.prototype.destroy = function() {}, Jt.prototype.sourceRectAtTime = function() {}, Jt.prototype.hide = function() {}, j([Gt, Lt, Mt, It], Jt), Kt.prototype = {
            ...
            createContainerElements: function() {
                ...
                if (this.data.ln && this.layerElement.setAttribute("id", this.data.ln), this.data.cl && this.layerElement.setAttribute("class", this.data.cl), 0 === this.data.ty && !this.data.hd) {
                    ...
                    if (f.setAttribute("id", m), f.appendChild(d), this.globalData.defs.appendChild(f), this.checkMasks()) {
                        var c = I("g");
                        c.setAttribute("clip-path", "url(" + i + "#" + m + ")"), c.appendChild(this.layerElement), this.transformedElement = c, a ? a.appendChild(this.transformedElement) : this.baseElement = this.transformedElement
                    } else this.layerElement.setAttribute("clip-path", "url(" + i + "#" + m + ")")
                }
            ...
            createRenderableComponents: function() {
                this.maskManager = new Et(this.data, this, this.globalData), this.renderableEffectsManager = new re
            },
            setMatte: function(t) {
        ...
        }, Zt.prototype.initElement = function(t, e, s) {
            this.lettersChangedFlag = !0, this.initFrame(), this.initBaseData(t, e, s), this.textProperty = new vt(this, t.t, this.dynamicProperties), this.textAnimator = new ut(t.t, this.renderType, this), this.initTransform(t, e, s), this.initHierarchy(), this.initRenderable(), this.initRendererElement(), this.createContainerElements(), this.createRenderableComponents(), this.createContent(), this.hide(), this.textAnimator.searchProperties(this.dynamicProperties)
        }, Zt.prototype.prepareFrame = function(t) {
            this._mdf = !1, this.prepareRenderableFrame(t), this.prepareProperties(t, this.isInRange), (this.textProperty._mdf || this.textProperty._isFirstFrame) && (this.buildNewText(), this.textProperty._isFirstFrame = !1, this.textProperty._mdf = !1)
        }, Zt.prototype.createPathShape = function(t, e) {
            var s, i, a = e.length,
                r = "";
            for (s = 0; s < a; s += 1) i = e[s].ks.k, r += lt(i, i.i.length, !0, t);
            return r
        }, Zt.prototype.updateDocumentData = function(t, e) {
            this.textProperty.updateDocumentData(t, e)
        }, Zt.prototype.canResizeFont = function(t) {
            this.textProperty.canResizeFont(t)
        }, Zt.prototype.setMinimumFontSize = function(t) {
            this.textProperty.setMinimumFontSize(t)
        }, Zt.prototype.applyTextPropertiesToMatrix = function(t, e, s, i, a) {
            ...
            e.translate(i, a, 0)
        }, Zt.prototype.buildColor = function(t) {
            return "rgb(" + Math.round(255 * t[0]) + "," + Math.round(255 * t[1]) + "," + Math.round(255 * t[2]) + ")"
        }, Zt.prototype.emptyProp = new yt, Zt.prototype.destroy = function() {}, j([Gt, Lt, Mt, It, Rt], Qt), Qt.prototype.initElement = function(t, e, s) {
        ...
        }, j([Gt, Lt, Kt, Mt, It, Rt], $t), $t.prototype.createContent = function() {
        ...
        }, j([$t], te), te.prototype.createContent = function() {
            var t = I("rect");
        ...
        }, j([Vt, Gt, It], ee), ee.prototype.renderFrame = function() {
            this.isInRange && this._canPlay && (this._isPlaying ? (!this.audio.playing() || Math.abs(this._currentTime / this.globalData.frameRate - this.audio.seek()) > .1) && this.audio.seek(this._currentTime / this.globalData.frameRate) : (this.audio.play(), this.audio.seek(this._currentTime / this.globalData.frameRate), this._isPlaying = !0))
        }, ee.prototype.show = function() {}, ee.prototype.hide = function() {
            ...
            return null
        }, ee.prototype.destroy = function() {}, ee.prototype.sourceRectAtTime = function() {}, ee.prototype.initExpressions = function() {}, j([Tt, Qt, Kt], se), j([Gt, Lt, Kt, Mt, It, Rt, Zt], ie), ie.prototype.createContent = function() {
            this.data.singleShape && !this.globalData.fontManager.chars && (this.textContainer = I("text"))
        }, ie.prototype.buildTextContents = function(t) {
            for (var e = 0, s = t.length, i = [], a = ""; e < s;) t[e] === String.fromCharCode(13) || t[e] === String.fromCharCode(3) ? (i.push(a), a = "") : a += t[e], e += 1;
            return i.push(a), i
        }, ie.prototype.buildNewText = function() {
            var t, e, s = this.textProperty.currentData;
            this.renderedLetters = M(s ? s.l.length : 0), s.fc ? this.layerElement.setAttribute("fill", this.buildColor(s.fc)) : this.layerElement.setAttribute("fill", "rgba(0,0,0,0)"), s.sc && (this.layerElement.setAttribute("stroke", this.buildColor(s.sc)), this.layerElement.setAttribute("stroke-width", s.sw)), this.layerElement.setAttribute("font-size", s.finalSize);
            ...
            if (!d || o || s.sz) {
                ...
                for (e = A.length, c = s.ps ? s.ps[1] + s.ascent : 0, t = 0; t < e; t += 1)(n = this.textSpans[t] || I("tspan")).textContent = A[t], n.setAttribute("x", 0), n.setAttribute("y", c), n.style.display = "inherit", _.appendChild(n), this.textSpans[t] = n, c += s.finalLineHeight;
        ...
        }, j([Gt, Lt, Kt, Ut, Mt, It, Rt], ae), ae.prototype.initSecondaryElement = function() {}, ae.prototype.identityMatrix = new q, ae.prototype.buildExpressionInterface = function() {}, ae.prototype.createContent = function() {
            this.searchShapes(this.shapesData, this.itemsData, this.prevViewData, this.layerElement, 0, [], !0), this.filterUniqueShapes()
        }, ae.prototype.filterUniqueShapes = function() {
        ...
        }, ae.prototype.setShapesAsAnimated = function(t) {
            var e, s = t.length;
            for (e = 0; e < s; e += 1) t[e].setAsAnimated()
        }, ae.prototype.createStyleElement = function(t, e) {
            var s, a = new Nt(t, e),
                r = a.pElem;
            return "st" === t.ty ? s = new Bt(this, t, a) : "fl" === t.ty ? s = new jt(this, t, a) : "gf" !== t.ty && "gs" !== t.ty || (s = new("gf" === t.ty ? Wt : Xt)(this, t, a), this.globalData.defs.appendChild(s.gf), s.maskId && (this.globalData.defs.appendChild(s.ms), this.globalData.defs.appendChild(s.of), r.setAttribute("mask", "url(" + i + "#" + s.maskId + ")"))), "st" !== t.ty && "gs" !== t.ty || (r.setAttribute("stroke-linecap", N[t.lc || 2]), r.setAttribute("stroke-linejoin", O[t.lj || 2]), r.setAttribute("fill-opacity", "0"), 1 === t.lj && r.setAttribute("stroke-miterlimit", t.ml)), 2 === t.r && r.setAttribute("fill-rule", "evenodd"), t.ln && r.setAttribute("id", t.ln), t.cl && r.setAttribute("class", t.cl), t.bm && (r.style["mix-blend-mode"] = z(t.bm)), this.stylesList.push(a), this.addToAnimatedContents(t, s), s
        }, ae.prototype.createGroupElement = function(t) {
            var e = new Ht;
            return t.ln && e.gr.setAttribute("id", t.ln), t.cl && e.gr.setAttribute("class", t.cl), t.bm && (e.gr.style["mix-blend-mode"] = z(t.bm)), e
        }, ae.prototype.createTransformElement = function(t, e) {
            var s = K.getTransformProperty(this, t, this),
                i = new qt(s, s.o, e);
            return this.addToAnimatedContents(t, i), i
        }, ae.prototype.createShapeElement = function(t, e, s) {
            var i = 4;
            "rc" === t.ty ? i = 5 : "el" === t.ty ? i = 6 : "sr" === t.ty && (i = 7);
            var a = new Ot(e, s, $.getShapeProp(this, t, i, this));
            return this.shapes.push(a), this.addShapeToModifiers(a), this.addToAnimatedContents(t, a), a
        }, ae.prototype.addToAnimatedContents = function(t, e) {
            for (var s = 0, i = this.animatedContents.length; s < i;) {
                if (this.animatedContents[s].element === e) return;
                s += 1
            }
            this.animatedContents.push({
                fn: Yt.createRenderFunction(t),
                element: e,
                data: t
            })
        }, ae.prototype.setElementStyles = function(t) {
            var e, s = t.styles,
                i = this.stylesList.length;
            for (e = 0; e < i; e += 1) this.stylesList[e].closed || s.push(this.stylesList[e])
        }, ae.prototype.reloadShapes = function() {
            var t;
        ...
        }, ae.prototype.searchShapes = function(t, e, s, i, a, r, n) {
        ...
        }, ae.prototype.renderShape = function() {
        ...
        j([T], he), he.prototype.setParams = function(t) {
            ...
            switch (t.animType ? e = t.animType : t.renderer && (e = t.renderer), e) {
                case "canvas":
                    ...
                    break;
                case "svg":
                    this.renderer = new Tt(this, t.rendererSettings);
                    break;
                default:
        ...
        }, he.prototype.setData = function(t, e) {
        ...
        }, he.prototype.includeLayers = function(t) {
        ...
        }, he.prototype.loadNextSegment = function() {
            var t = this.animationData.segments;
            if (!t || 0 === t.length || !this.autoloadSegments) return this.trigger("data_ready"), void(this.timeCompleted = this.totalFrames);
            var e = t.shift();
            this.timeCompleted = e.time * this.frameRate;
            var s = this.path + this.fileName + "_" + this.segmentPos + ".json";
            this.segmentPos += 1, ct.load(s, this.includeLayers.bind(this), function() {
                this.trigger("data_failed")
            }.bind(this))
        }, he.prototype.loadSegments = function() {
            this.animationData.segments || (this.timeCompleted = this.totalFrames), this.loadNextSegment()
        }, he.prototype.imagesLoaded = function() {
            this.trigger("loaded_images"), this.checkLoaded()
        }, he.prototype.preloadImages = function() {
        ...
        }, he.prototype.waitForFontsLoaded = function() {
            this.renderer && (this.renderer.globalData.fontManager.isLoaded ? this.checkLoaded() : setTimeout(this.waitForFontsLoaded.bind(this), 20))
        }, he.prototype.checkLoaded = function() {
            !this.isLoaded && this.renderer.globalData.fontManager.isLoaded && (this.imagePreloader.loadedImages() || "canvas" !== this.renderer.rendererType) && this.imagePreloader.loadedFootages() && (this.isLoaded = !0, H.completeData(this.animationData, this.renderer.globalData.fontManager), e && e.initExpressions(this), this.renderer.initItems(), setTimeout(function() {
                this.trigger("DOMLoaded")
            }.bind(this), 0), this.gotoFrame(), this.autoplay && this.play())
        }, he.prototype.resize = function() {
            this.renderer.updateContainerSize()
        }, he.prototype.setSubframe = function(t) {
            this.isSubframeEnabled = !!t
        }, he.prototype.gotoFrame = function() {
        ...
        }, he.prototype.goToAndPlay = function(t, e, s) {
            if (!s || this.name === s) {
                var i = Number(t);
                if (isNaN(i)) {
                    var a = this.getMarkerData(t);
        ...
        }, he.prototype.advanceTime = function(t) {
        ...
        }, he.prototype.playSegments = function(t, e) {
            if (e && (this.segments.length = 0), "object" == typeof t[0]) {
                var s, i = t.length;
                for (s = 0; s < i; s += 1) this.segments.push(t[s])
            } else this.segments.push(t);
            this.segments.length && e && this.adjustSegment(this.segments.shift(), 0), this.isPaused && this.play()
        }, he.prototype.resetSegments = function(t) {
            this.segments.length = 0, this.segments.push([this.animationData.ip, this.animationData.op]), t && this.checkSegments(0)
        }, he.prototype.checkSegments = function(t) {
            return !!this.segments.length && (this.adjustSegment(this.segments.shift(), t), !0)
        }, he.prototype.destroy = function(t) {
            t && this.name !== t || !this.renderer || (this.renderer.destroy(), this.imagePreloader.destroy(), this.trigger("destroy"), this._cbs = null, this.onEnterFrame = null, this.onLoopComplete = null, this.onComplete = null, this.onSegmentStart = null, this.onDestroy = null, this.renderer = null, this.renderer = null, this.imagePreloader = null, this.projectInterface = null)
        }, he.prototype.setCurrentRawFrameValue = function(t) {
            this.currentRawFrame = t, this.gotoFrame()
        }, he.prototype.setSpeed = function(t) {
            this.playSpeed = t, this.updaFrameModifier()
        }, he.prototype.setDirection = function(t) {
            this.playDirection = t < 0 ? -1 : 1, this.updaFrameModifier()
        }, he.prototype.setVolume = function(t, e) {
            e && this.name !== e || this.audioController.setVolume(t)
        }, he.prototype.getVolume = function() {
            return this.audioController.getVolume()
        }, he.prototype.mute = function(t) {
            t && this.name !== t || this.audioController.mute()
        }, he.prototype.unmute = function(t) {
            t && this.name !== t || this.audioController.unmute()
        }, he.prototype.updaFrameModifier = function() {
            this.frameModifier = this.frameMult * this.playSpeed * this.playDirection, this.audioController.setRate(this.playSpeed * this.playDirection)
        }, he.prototype.getPath = function() {
            return this.path
        }, he.prototype.getAssetsPath = function(t) {
            var e = "";
            if (t.e) e = t.p;
            ...
            return e
        }, he.prototype.getAssetData = function(t) {
            ...
            this.renderer.show()
        }, he.prototype.getDuration = function(t) {
        ...
        }, he.prototype.triggerConfigError = function(t) {
        ...
        pe.play = ne.play, pe.pause = ne.pause, pe.setLocationHref = function(t) {
            i = t
        }, pe.togglePause = ne.togglePause, pe.setSpeed = ne.setSpeed, pe.setDirection = ne.setDirection, pe.stop = ne.stop, pe.searchAnimations = fe, pe.registerAnimation = ne.registerAnimation, pe.loadAnimation = function(t) {
            return ne.loadAnimation(t)
        }, pe.setSubframeRendering = function(t) {
            r = t
        }, pe.resize = ne.resize, pe.goToAndStop = ne.goToAndStop, pe.destroy = ne.destroy, pe.setQuality = function(t) {
        ...
        }, pe.installPlugin = function(t, s) {
            "expressions" === t && (e = s)
        }, pe.freeze = ne.freeze, pe.unfreeze = ne.unfreeze, pe.setVolume = ne.setVolume, pe.mute = ne.mute, pe.unmute = ne.unmute, pe.getRegisteredAnimations = ne.getRegisteredAnimations, pe.setIDPrefix = function(t) {
            n = t
        }, pe.__getFactory = function(t) {
            switch (t) {
        ...
        le = me.src.replace(/^[^\?]+\??/, ""),
            function(t) {
                for (var e = le.split("&"), s = 0; s < e.length; s += 1) {
                    var i = e[s].split("=");
                    if (decodeURIComponent(i[0]) == t) return decodeURIComponent(i[1])
                }
            }("renderer");
        var ce = setInterval((function() {
            "complete" === document.readyState && (clearInterval(ce), fe())
        }), 100);
        return pe
    ...
    class r {
        ...
        0 !== t.length && t.forEach((t => {
            if (t) {
                ...
                const s = t.dataset.lottieJson;
                e = null != s ? { ...e,
                    animationData: JSON.parse(window.atob(s))
                } : { ...e,
